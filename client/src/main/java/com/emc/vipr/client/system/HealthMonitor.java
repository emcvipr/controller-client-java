...
public class HealthMonitor {
     ...
     * <p>
     * If interval value is passed it will return differential disk stats: difference
     * between first report (contains stats for the time since system startup) and
     ...
     * <p>
     * Node health status: Good - when node is reachable and all its services
     * are GOOD Unavailable - when node is not reachable Degraded - when node
     * is reachable and any of its service is Unavailable/Degraded Node/syssvc
     * Unavailable - when node is down or syssvc is not Unavailable on the node
     * <p>
